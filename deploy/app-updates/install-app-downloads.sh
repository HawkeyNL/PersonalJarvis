...
for directory in /usr/local/libexec /etc/jarvis/app-downloads /var/lib/jarvis-public-downloads /var/lib/jarvis-public-downloads/ios; do
...
for target in /usr/local/libexec/jarvis-app-downloads /usr/local/libexec/jarvis-app-downloads-set-token /etc/systemd/system/jarvis-app-downloads.service /etc/systemd/system/jarvis-app-downloads.timer; do
